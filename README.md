Este proyecto corresponde al trabajo de MLOps de la materia del ISTEA. La idea general es armar un pipeline completo y reproducible para predecir churn de clientes de telecomunicaciones usando buenas prácticas de versionado de datos, limpieza, entrenamiento de un modelo y ejecución automática mediante DVC.
